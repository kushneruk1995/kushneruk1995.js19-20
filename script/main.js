...
$(document).ready(function(){
  $('.accordion__container-link').click(function (e){
      e.preventDefault();
      if($(this).hasClass('accordion__container-link__active')) {
        $(this).removeClass('accordion__container-link__active');
        $(this).addClass('accordion__container-link__no-active');
        $(this).siblings('.accordion__container-content').slideUp(200);
      } else {
        $(this).removeClass('accordion__container-link__no-active');
        $(this).addClass('accordion__container-link__active');
        $('.accordion__container__link-icon').addClass('active');
        $(this).siblings('.accordion__container-content').slideDown(200);
      }
    })
  });
